    ...
    // ── Insights ─────────────────────────────────────────────────────────────
    {
      ...
      items: [
        ...
        'insights/snapshots',
        {
          ...
          label: 'Alerting',
          collapsed: true,
          link: { type: 'doc', id: 'insights/alerting/alerting' },
          items: [
            'insights/alerting/how-it-works',
            'insights/alerting/alert-rules',
            {
              type: 'category',
              label: 'Contact points',
              collapsed: true,
              link: { type: 'doc', id: 'insights/alerting/contact-points/contact-points' },
              items: [
                'insights/alerting/contact-points/slack',
                'insights/alerting/contact-points/email',
                'insights/alerting/contact-points/pagerduty',
                'insights/alerting/contact-points/opsgenie',
                'insights/alerting/contact-points/teams',
                'insights/alerting/contact-points/telegram',
                'insights/alerting/contact-points/discord',
                'insights/alerting/contact-points/sns',
                'insights/alerting/contact-points/webhook',
              ],
            },
            'insights/alerting/notification-policies',
            'insights/alerting/suppress',
            'insights/alerting/templates',
            'insights/alerting/monitor',
            'insights/alerting/troubleshooting',
            'insights/alerting/best-practices',
            'insights/alerting/grafana',
          ],
        },
      ],
    },
