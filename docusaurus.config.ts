      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Privacy Policy', href: 'https://xscalerlabs.com/privacy' },
            { label: 'Terms & Conditions', href: 'https://xscalerlabs.com/terms' },
            { label: 'Security', href: 'https://xscalerlabs.com/security' },
            { label: 'Cookie Policy', href: 'https://xscalerlabs.com/cookies' },
          ],
        },
      ],
