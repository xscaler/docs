...
- The URL is `https://euw1-01.m.xscalerlabs.com` (no path suffix)
...
Copy these into a new Grafana panel to build your first dashboard.
...
- Use Explore with query `up` to confirm the connection works.
